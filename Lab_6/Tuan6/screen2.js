...
const colorSquare = [
  { MaMau: "#C5F1FB", img: require("./Hinh/vs_blue.png") },
  { MaMau: "#F30D0D", img: require("./Hinh/vs_red.png") },
  { MaMau: "#000000", img: require("./Hinh/vs_black.png") },
  { MaMau: "#234896", img: require("./Hinh/vs_silver.png") },
];

const screen2 = ({ navigation, route }) => {
  const [Mau, setMau] = react.useState(null);
  const [anh, setanh] = react.useState(require("./Hinh/vs_blue.png"));
  const getMau = (Mau) => {
    setMau(Mau);
  };
  const getAnh = (anh) => {
